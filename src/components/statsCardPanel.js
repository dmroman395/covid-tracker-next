...
function StatsCardPanel() {
    ...
    if (Object.keys(stats).length > 0) {
        statsObj = {
            totalConfirmedCases : stats.stats.totalConfirmedCases,
            newlyConfirmedCases : stats.stats.newlyConfirmedCases,
            totalDeaths : stats.stats.totalDeaths,
            newDeaths : stats.stats.newDeaths,
            totalRecoveredCases : stats.stats.totalRecoveredCases,
            newlyRecoveredCases : stats.stats.newlyRecoveredCases,
            history: stats.stats.history
        }
    } else {
        statsObj = {
            totalConfirmedCases : test.totalConfirmedCases,
            newlyConfirmedCases : test.newlyConfirmedCases,
            totalDeaths : test.totalDeaths,
            newDeaths : test.newDeaths,
            totalRecoveredCases : test.totalRecoveredCases,
            newlyRecoveredCases : test.newlyRecoveredCases,
            history: test.history
        }
    }
    return (
        <div className={styles.statsGrid}>
            <StatsCard type={'Total Confirmed Cases'} stat={statsObj.totalConfirmedCases}/>
            <StatsCard type={'Newly Confirmed Cases'} stat={statsObj.newlyConfirmedCases}/>
            <StatsCard type={'Total Deaths'} stat={statsObj.totalDeaths}/>
            <StatsCard type={'New Deaths'} stat={statsObj.newDeaths}/>
            <StatsCard type={'Total Recovered Cases'} stat={statsObj.totalRecoveredCases}/>
            <StatsCard type={'Newly Recovered Cases'} stat={statsObj.newlyRecoveredCases}/>
            <ChartCard dataSet={statsObj.history}/>
        </div>
    )
}
